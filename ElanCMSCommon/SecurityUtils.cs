    ...
    public static class SecurityUtils
    {
        ...
        public static SPGroup CreateSiteGroup(SPSite site, string ownerGroupName, string groupName, string description)
        {
            ...
            if (!SiteGroupExists(site, groupName))
            {
                ...
                //try to use specified group as group owner, site owner otherwise
                try
                {
                    owner = site.RootWeb.SiteGroups[ownerGroupName];
                }
                catch {
                    owner = site.Owner;
                }
                ...
                try
                {
                    site.RootWeb.SiteGroups.Add(groupName, owner, null, description);
                }
                catch (Exception ex)
                {
